...
import com.example.prolactancia.Controladores.DolorGrietasController;
import com.example.prolactancia.Controladores.PechosCongestionadosController;
...
public class DolorGrietas extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_mensaje.setText("Las grietas en el pezón...\n" +
                "son heridas o lesiones que aparecen\n" +
                "durante la lactancia y hacen q esta\n" +
                "resulte dolorosa.\n");
