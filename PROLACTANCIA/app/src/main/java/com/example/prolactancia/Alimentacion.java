...
import com.example.prolactancia.Controladores.AlimentacionController;
...
public class Alimentacion extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_mensaje.setText("La alimentacion de la\n" +
                "madre debe ser...\n" +
                "saludable para cubrir sus necesidades y\n" +
                "tener una adecuada producción de leche.\n");
