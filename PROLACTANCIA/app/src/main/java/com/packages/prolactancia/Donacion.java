...
import com.packages.prolactancia.Controladores.DonacionController;

import com.packages.prolactancia.R;

public class Donacion extends AppCompatActivity implements  View.OnClickListener{

    TextView txt_titulo,txt_mensaje;
    TabLayout contenido;
    ViewPager vista_pagina;
    TabItem tab_banco,tab_requisitos, tab_preparacion;
    DonacionController d_controlador;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_mensaje.setText("Los principales beneficiarios...\n" +
                "de los bancos de leche humanos son los bebés prematuros y d ebajo peso al nacer.\n");

        contenido =  findViewById(R.id.contenido);
        vista_pagina = findViewById(R.id.vista_contenido);
        representativa = findViewById(R.id.img_representativa);
        tab_banco = findViewById(R.id.tab_banco);
        tab_requisitos = findViewById(R.id.tab_requisitos);
        tab_preparacion = findViewById(R.id.tab_preparacion);

        d_controlador = new DonacionController(getSupportFragmentManager(),contenido.getTabCount());
        vista_pagina.setAdapter(d_controlador);
        contenido.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition()==0){
                    d_controlador.notifyDataSetChanged();
                }
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            case R.id.bt_atras:
                Intent atras = new Intent(Donacion.this, MenuPrincipal.class);
                this.finish();
                startActivity(atras);
                break;
            case R.id.bt_home:
                Intent home = new Intent(Donacion.this, MenuPrincipal.class);
                this.finish();
                startActivity(home);
                break;
            default:
